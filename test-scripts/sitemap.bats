...
@test "sitemap.txt has exactly nineteen URLs (homepage + 16 relocated/new docs + HISTORY + CHANGELOG)" {
  local count
...
@test "sitemap.xml contains exactly nineteen <url> entries matching sitemap.txt" {
  local count
